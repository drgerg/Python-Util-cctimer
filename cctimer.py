...
#
def timer(duration, dotNum, threadStop): ## this function can be used as part of a while loop to 
    logger = logging.getLogger(__name__) ## stop the loop and exit the thread.
    starttime = time.time()
    dur = duration
